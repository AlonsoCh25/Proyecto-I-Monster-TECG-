...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Image deck = new Image(getClass().getResourceAsStream("/imagenes/Fondo2.jpg"));
        ...
        Image carta1 = new Image(getClass().getResourceAsStream("/imagenes/1.jpg"));
        Image carta2 = new Image(getClass().getResourceAsStream("/imagenes/2.jpg"));
        Image carta3 = new Image(getClass().getResourceAsStream("/imagenes/3.jpg"));
        ...
        BackgroundImage myBI= new BackgroundImage(new Image("/imagenes/Fondo3.jpg",1200,900,false,true),
        ...
        BackgroundImage FondoCentro= new BackgroundImage(new Image("/imagenes/Fondo1.jpg",1800,1000,false,true),
                BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, BackgroundSize.DEFAULT);
